...
import Book2 from '../../../assets/bookcover/book1.jpg';
import Book3 from '../../../assets/bookcover/book1.jpg';
import Book4 from '../../../assets/bookcover/book1.jpg';
import Book5 from '../../../assets/bookcover/book1.jpg';
import Book6 from '../../../assets/bookcover/book1.jpg';
import Book7 from '../../../assets/bookcover/book1.jpg';
import Book8 from '../../../assets/bookcover/book1.jpg';
import Book9 from '../../../assets/bookcover/book1.jpg';
import Book10 from '../../../assets/bookcover/book1.jpg';
const Product = () => {
  return (
    <section className='detail-page flex-grow-1'>
        <div className='container'>
            <div className='title-section'>
                <p className='title-page font-22px'>Category Name</p>
            </div>
                        ...
                        <div className='card card-book'>
                            <div className='row'>
                                 <div className='col-lg-4'>
                                      <img className='card-img-top' src={Book1} alt='Books'/>
