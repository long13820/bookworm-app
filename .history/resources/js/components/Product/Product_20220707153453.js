...
export default class Product extends React.Component{
    ...
    getDetail(){
        axios.get('http://localhost:8000/api/books/' + this.props.match.params.id).then((result) => {
            ...
            this.setState({
                details: JSON.stringify(result.data[0])
            });
        })
    ...
    <section className='detail-page flex-grow-1'>
        ...
        <div className='container'>
            <div className='title-section'>
                <p className='title-page font-22px'>Category: {this.state.details.category.category_name}</p>
            </div>
