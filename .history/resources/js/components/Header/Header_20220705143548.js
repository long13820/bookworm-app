...
import { Button, Card, CardBody, Collapse, Fade, Modal, ModalHeader, Nav, Navbar, NavbarToggler, NavItem, NavLink } from "reactstrap";
import "./header.css";
            ...
            <Modal isOpen={this.state.modal} toggle={this.handleModal}>
                <ModalHeader toggle={this.handleModal}>
                    <div className="d-flex">
                        <div className="flex-grow-1 text-center pointer border-right" onClick={this.set}>
