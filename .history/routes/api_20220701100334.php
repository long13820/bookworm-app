...
Route::post('books/{id}/review',[BookController::class,'createBookReview']);

Route::get('books/{id}', [BookController::class,'getBookById']);

Route::get('books/{id}/reviews',[BookController::class,'getRatingDetails']);

Route::get('search/{id}/reviews',[BookController::class,'searchReviews']);
